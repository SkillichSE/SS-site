...
const CTA = () => {
  ...
  return (
    <section
      ref={ref}
      className="py-32 px-6 relative z-10 bg-gradient-to-r from-accent-cyan/5 to-accent-green/5 border-y border-accent-cyan/20"
    >
      <div className="max-w-4xl mx-auto text-center">
        <motion.h2
          ...
          className="font-orbitron text-6xl font-black mb-8 bg-gradient-to-r from-accent-silver to-accent-blue bg-clip-text text-transparent"
        >
          Готовы попробовать?
        </motion.h2>
